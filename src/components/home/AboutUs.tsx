...
export const AboutUs = () => (
    <section className="py-16 px-4 bg-ground/30 text-center flex flex-col items-center justify-center" id="about-us">
        ...
        <p className="text-muted text-base md:text-lg max-w-2xl mx-auto mb-6 leading-relaxed font-sans">
            <span className="lowercase text-ink font-medium">moneta <span className="text-accent">prime</span></span> is a modern digital trading platform built to provide users with a secure, transparent, and efficient trading experience.
        </p>
        <p className="text-muted text-sm sm:text-base max-w-3xl mx-auto mb-2 leading-relaxed font-sans">
            Our mission is to make trading accessible and straightforward for everyone. By combining innovative technology with an intuitive interface, <span className="lowercase text-ink font-medium">moneta <span className="text-accent">prime</span></span> empowers users to manage their investments confidently and stay connected to global financial markets. We focus on security, simplicity, and continuous innovation to create a platform that traders can rely on every day.
        </p>
    </section>
);
