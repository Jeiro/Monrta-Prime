...
export const renderKeycap = (type: string) => {
  switch (type) {
    case 'MSFT':
      return (
        <div key="msft" className="bg-surface border border-line rounded-xl p-3 flex flex-col justify-center items-center shadow-[inset_0_2px_2px_rgba(255,255,255,0.1),0_4px_0_#06080d,0_8px_15px_rgba(0,0,0,0.85)] h-12 w-16 transform-gpu">
          <span className="text-blue-400 font-bold text-2xs tracking-wider font-sans leading-none mb-1">MSFT</span>
    ...
    case 'CAT':
      return (
        <div key="cat" className="bg-surface border border-line rounded-xl p-3 flex flex-col justify-center items-center shadow-[inset_0_2px_2px_rgba(255,255,255,0.1),0_4px_0_#06080d,0_8px_15px_rgba(0,0,0,0.85)] h-12 w-16 relative overflow-hidden">
          <span className="text-white font-black text-2xs font-sans relative z-10 leading-none mb-0.5">CAT</span>
    ...
    case 'DIS':
      return (
        <div key="dis" className="bg-surface border border-line rounded-xl p-3 flex flex-col justify-center items-center shadow-[inset_0_2px_2px_rgba(255,255,255,0.1),0_4px_0_#06080d,0_8px_15px_rgba(0,0,0,0.85)] h-12 w-16 text-sky-400">
    ...
    case 'NFLX':
      return (
        <div key="nflx" className="bg-surface border border-line rounded-xl p-3 flex flex-col justify-center items-center shadow-[inset_0_2px_2px_rgba(255,255,255,0.1),0_4px_0_#06080d,0_8px_15px_rgba(0,0,0,0.85)] h-12 w-16">
    ...
    case 'TWTR':
      return (
        <div key="twtr" className="bg-surface border border-line rounded-xl p-3 flex flex-col justify-center items-center shadow-[inset_0_2px_2px_rgba(255,255,255,0.1),0_4px_0_#06080d,0_8px_15px_rgba(0,0,0,0.85)] h-12 w-16">
    ...
    case 'GOOG':
      return (
        <div key="goog" className="bg-surface border border-line rounded-xl p-3 flex flex-col justify-center items-center shadow-[inset_0_2px_2px_rgba(255,255,255,0.1),0_4px_0_#06080d,0_8px_15px_rgba(0,0,0,0.85)] h-12 w-16">
    ...
    case 'AAPL':
      return (
        <div key="aapl" className="bg-white border border-line rounded-xl p-3 flex flex-col justify-center items-center shadow-[inset_0_2px_2.5px_white,0_4px_0_#d1d5db,0_15px_25px_rgba(255,255,255,0.65)] h-12 w-16 relative scale-105 z-10 transition-transform">
    ...
    case 'SLACK':
      return (
        <div key="slack" className="bg-surface border border-line rounded-xl p-3 flex flex-col justify-center items-center shadow-[inset_0_2px_2px_rgba(255,255,255,0.1),0_4px_0_#06080d,0_8px_15px_rgba(0,0,0,0.85)] h-12 w-16">
    ...
    case 'CSCO':
      return (
        <div key="csco" className="bg-surface border border-line rounded-xl p-3 flex flex-col justify-center items-center shadow-[inset_0_2px_2px_rgba(255,255,255,0.1),0_4px_0_#06080d,0_8px_15px_rgba(0,0,0,0.85)] h-12 w-16">
          ...
          <span className="text-2xs text-[#00BCEB] font-extrabold tracking-widest leading-none uppercase select-none font-sans">CISCO</span>
        </div>
      );
    case 'SBUX':
      return (
        <div key="sbux" className="bg-surface border border-line rounded-xl p-3 flex flex-col justify-center items-center shadow-[inset_0_2px_2px_rgba(255,255,255,0.1),0_4px_0_#06080d,0_8px_15px_rgba(0,0,0,0.85)] h-12 w-16">
    ...
    case 'AMZN':
      return (
        <div key="amzn" className="bg-surface border border-line rounded-xl p-3 flex flex-col justify-center items-center shadow-[inset_0_2px_2px_rgba(255,255,255,0.1),0_4px_0_#06080d,0_8px_15px_rgba(0,0,0,0.85)] h-12 w-16">
          <span className="text-white font-extrabold text-xs font-sans leading-none -mb-0.5">a</span>
    ...
    case 'MCD':
      return (
        <div key="mcd" className="bg-surface border border-line rounded-xl p-3 flex flex-col justify-center items-center shadow-[inset_0_2px_2px_rgba(255,255,255,0.1),0_4px_0_#06080d,0_8px_15px_rgba(0,0,0,0.85)] h-12 w-16">
    ...
    case 'NVDA':
      return (
        <div key="nvda" className="bg-surface border border-line rounded-xl p-3 flex flex-col justify-center items-center shadow-[inset_0_2px_2px_rgba(255,255,255,0.1),0_4px_0_#06080d,0_8px_15px_rgba(0,0,0,0.85)] h-12 w-16">
    ...
    case 'EBAY':
      return (
        <div key="ebay" className="bg-surface border border-line rounded-xl p-3 flex flex-col justify-center items-center shadow-[inset_0_2px_2px_rgba(255,255,255,0.1),0_4px_0_#06080d,0_8px_15px_rgba(0,0,0,0.85)] h-12 w-16">
          <div className="flex items-center space-x-0.2 select-none font-bold" style={{ fontFamily: '"Helvetica Neue", Helvetica, Arial, sans-serif' }}>
            <span className="text-[#E53238] font-bold text-2xs tracking-tight">e</span>
            <span className="text-[#0064D2] font-semibold text-2xs tracking-tight -ml-[0.5px]">b</span>
            <span className="text-[#F5AF02] font-semibold text-xs tracking-tight -ml-[1px]">a</span>
            <span className="text-[#86B817] font-semibold text-2xs tracking-tight -ml-[1.2px]">y</span>
          </div>
        </div>
      );
    case 'BIDU':
      return (
        <div key="bidu" className="bg-surface border border-line rounded-xl p-3 flex flex-col justify-center items-center shadow-[inset_0_2px_2px_rgba(255,255,255,0.1),0_4px_0_#06080d,0_8px_15px_rgba(0,0,0,0.85)] h-12 w-16">
    ...
    case 'MONETA':
      return (
        <div key="moneta" className="bg-surface border-2 border-accent/95 rounded-xl p-2.5 flex flex-col justify-center items-center shadow-[0_4px_0_#2E6BE0,0_15px_22px_rgba(106,165,255,0.55)] h-12 w-16 scale-105 relative z-10 transition-transform">
          <span className="text-accent font-extrabold text-sm leading-none font-sans">M</span>
          <span className="text-2xs text-white/95 font-mono tracking-widest uppercase mt-0.5 leading-none">MONETA</span>
          <div className="absolute inset-0 rounded-xl bg-gradient-to-t from-accent/15 to-transparent mix-blend-overlay pointer-events-none"></div>
        </div>
      );
    default:
      return null;
