...
export const renderKeycap = (type: string) => {
  switch (type) {
    case 'MSFT':
      return (
        <div key="msft" className="bg-surface border border-neutral-800 rounded-xl p-3 flex flex-col justify-center items-center shadow-[inset_0_2px_2px_rgba(255,255,255,0.1),0_4px_0_#06080d,0_8px_15px_rgba(0,0,0,0.85)] h-12 w-16 transform-gpu">
    ...
    case 'CAT':
      return (
        <div key="cat" className="bg-surface border border-neutral-800 rounded-xl p-3 flex flex-col justify-center items-center shadow-[inset_0_2px_2px_rgba(255,255,255,0.1),0_4px_0_#06080d,0_8px_15px_rgba(0,0,0,0.85)] h-12 w-16 relative overflow-hidden">
    ...
    case 'DIS':
      return (
        <div key="dis" className="bg-surface border border-neutral-800 rounded-xl p-3 flex flex-col justify-center items-center shadow-[inset_0_2px_2px_rgba(255,255,255,0.1),0_4px_0_#06080d,0_8px_15px_rgba(0,0,0,0.85)] h-12 w-16 text-sky-400">
    ...
    case 'NFLX':
      return (
        <div key="nflx" className="bg-surface border border-neutral-800 rounded-xl p-3 flex flex-col justify-center items-center shadow-[inset_0_2px_2px_rgba(255,255,255,0.1),0_4px_0_#06080d,0_8px_15px_rgba(0,0,0,0.85)] h-12 w-16">
    ...
    case 'TWTR':
      return (
        <div key="twtr" className="bg-surface border border-neutral-800 rounded-xl p-3 flex flex-col justify-center items-center shadow-[inset_0_2px_2px_rgba(255,255,255,0.1),0_4px_0_#06080d,0_8px_15px_rgba(0,0,0,0.85)] h-12 w-16">
    ...
    case 'GOOG':
      return (
        <div key="goog" className="bg-surface border border-neutral-800 rounded-xl p-3 flex flex-col justify-center items-center shadow-[inset_0_2px_2px_rgba(255,255,255,0.1),0_4px_0_#06080d,0_8px_15px_rgba(0,0,0,0.85)] h-12 w-16">
    ...
    case 'SLACK':
      return (
        <div key="slack" className="bg-surface border border-neutral-800 rounded-xl p-3 flex flex-col justify-center items-center shadow-[inset_0_2px_2px_rgba(255,255,255,0.1),0_4px_0_#06080d,0_8px_15px_rgba(0,0,0,0.85)] h-12 w-16">
    ...
    case 'CSCO':
      return (
        <div key="csco" className="bg-surface border border-neutral-800 rounded-xl p-3 flex flex-col justify-center items-center shadow-[inset_0_2px_2px_rgba(255,255,255,0.1),0_4px_0_#06080d,0_8px_15px_rgba(0,0,0,0.85)] h-12 w-16">
    ...
    case 'SBUX':
      return (
        <div key="sbux" className="bg-surface border border-neutral-800 rounded-xl p-3 flex flex-col justify-center items-center shadow-[inset_0_2px_2px_rgba(255,255,255,0.1),0_4px_0_#06080d,0_8px_15px_rgba(0,0,0,0.85)] h-12 w-16">
    ...
    case 'AMZN':
      return (
        <div key="amzn" className="bg-surface border border-neutral-800 rounded-xl p-3 flex flex-col justify-center items-center shadow-[inset_0_2px_2px_rgba(255,255,255,0.1),0_4px_0_#06080d,0_8px_15px_rgba(0,0,0,0.85)] h-12 w-16">
    ...
    case 'MCD':
      return (
        <div key="mcd" className="bg-surface border border-neutral-800 rounded-xl p-3 flex flex-col justify-center items-center shadow-[inset_0_2px_2px_rgba(255,255,255,0.1),0_4px_0_#06080d,0_8px_15px_rgba(0,0,0,0.85)] h-12 w-16">
    ...
    case 'NVDA':
      return (
        <div key="nvda" className="bg-surface border border-neutral-800 rounded-xl p-3 flex flex-col justify-center items-center shadow-[inset_0_2px_2px_rgba(255,255,255,0.1),0_4px_0_#06080d,0_8px_15px_rgba(0,0,0,0.85)] h-12 w-16">
    ...
    case 'EBAY':
      return (
        <div key="ebay" className="bg-surface border border-neutral-800 rounded-xl p-3 flex flex-col justify-center items-center shadow-[inset_0_2px_2px_rgba(255,255,255,0.1),0_4px_0_#06080d,0_8px_15px_rgba(0,0,0,0.85)] h-12 w-16">
    ...
    case 'BIDU':
      return (
        <div key="bidu" className="bg-surface border border-neutral-800 rounded-xl p-3 flex flex-col justify-center items-center shadow-[inset_0_2px_2px_rgba(255,255,255,0.1),0_4px_0_#06080d,0_8px_15px_rgba(0,0,0,0.85)] h-12 w-16">
